...
def guess_checker(guess, secret_word):
    if guess in incorrect_list:
        ...
        print('\nYou guessed a letter' + Fore.GREEN + ' correctly!' + Fore.RESET)
    else:
...
"""
Line 82: Loops through the letters in the secret_word
Line 83: If a letter is in correct_list it will replace the spot with the letter (i).
Line 86: If there isn't a correct letter it will print '_' in position of the secret_word
"""
...
def spaceman(secret_word):
    while True:
        ...
        if win == False:
            print(
                Fore.RED + f'You lost! The word was: {secret_word}' + Fore.RESET)
            break
        elif win == True:
            print(
                Fore.GREEN + f'You won! The word was: {secret_word}' + Fore.RESET)
            break
